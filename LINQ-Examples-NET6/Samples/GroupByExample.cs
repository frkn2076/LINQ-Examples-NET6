...
namespace LINQ_Examples_NET6.Samples
{
    class GroupByExample
    {
        ...
        {
            var colors = new List<string>() { "Red", "Green", "blue", "Black" };
            var result = colors.GroupBy(x => x.Substring(0, 1), new IgnoreCaseComparer()).ToList();
        ...
        {
            var colors = new List<string>() { "Red", "Green", "blue", "Black" };
            var result = colors.GroupBy(x => x.Substring(0, 1), x => x.Substring(0, 1), new IgnoreCaseComparer()).ToList();
